main() {
    ...
    echo -e "THEME INSTALL FUCK YOU IM LAZY TO NAME SHIT"
    echo -e "Feel free to massage by pickle for money"
    echo -e "receiving xferd.."
    curl "https://raw.githubusercontent.com/ThatsMyMute/macsploit_themes_auto/main/5.js" -o "./theme-tomorrow_night.js"
